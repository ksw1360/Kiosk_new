...
namespace Kiosk
{
    public partial class InputAddress : Form
    {
            ...
            try
            {
                ...
                using (Stream responseStream = response.GetResponseStream())
                {
                    using (System.IO.StreamReader reader = new System.IO.StreamReader(responseStream))
                    {
                        ...
                        {
                            this.btnNext2.BackgroundImage = Properties.Resources.다음2;
                        }
                        else
                        {
                            this.btnNext2.BackgroundImage = Properties.Resources.다음1;
                        }
                    }
                }
            }
        ...
        private void InputAddress_VisibleChanged(object sender, EventArgs e)
        {
